    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        <section>
          ...
          <p className="mb-10">
            Yarn Toolkit was created to simplify the planning and design process
            so that more time can be spent making. This site aims to remove the
            barriers of repetitive manual charting and confusing symbol
            placement, making the journey from idea to finished project as
            smooth, intuitive, and enjoyable as possible.
          </p>
        </section>
        <section>
          ...
          <p className="mb-10">
            ...
            most complex ideas to life more easily.
          </p>
        </section>
        <section>
