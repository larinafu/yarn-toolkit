...
const ValidationIndicator = ({
  ...
  return (
    <div className="relative">
      ...
      >
        {errorMsg ? (
          <Image
            ...
            alt="There is something wrong with your inputs"
            width={20}
            height={20}
          />
        ) : (
          <Image
            ...
            alt="Everything looks good! You can proceed with your knitting chart creation."
            width={20}
            height={20}
          />
        )}
      ...
      {isOpen && (
        <div className="card absolute fadeInFast w-30 z-10 right-0">
          {errorMsg}
        </div>
      )}
    </div>
